...
import EntranceAnswerSheet from "./EntranceAnswerSheet";
import axios from "axios";
import * as XLSX from "xlsx";
import EntranceSheet from "./EntranceSheet";
    ...
    const topExamBar = useMemo(
        () => (
            <div className="examPageContainer" style={{ overflow: 'hidden' }}>
                <Link to={'/roadmap/create'} className="closeBtn">
                    <div >
    ...
    const mainContent = useMemo(
        () => (
            <div className="mainExamContainer" style={{ overflow: 'hidden' }}>
                <EntranceSheet typeSheet="exam" data={data} testName={testCode} />
                <EntranceAnswerSheet typeSheet="exam" data={data} />
            </div>
        ), [data]
    );
    return (
