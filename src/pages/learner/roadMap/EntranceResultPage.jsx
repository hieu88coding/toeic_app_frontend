...
import "./entranceResultPage.scss";
import { Divider, Card, Tooltip, Row, Col, Table, Button } from "antd";
import { CloseOutlined, CheckCircleTwoTone, CloseCircleTwoTone, MinusCircleTwoTone, FireTwoTone, PushpinTwoTone, AudioTwoTone, CheckOutlined } from "@ant-design/icons";
import axios from "axios";
import * as XLSX from "xlsx";
import DetailPart from "../resultPage/DetailPart";


const EntranceResultPage = () => {
    ...
    return (
        <div>
            <div className="entranceResultPageContainer">
                <div className="examPageContainer" style={{ overflow: 'hidden' }}>
                    ...
                    <div onClick={() => handleNavigate()} className="finish">
                        <div>
...
export default EntranceResultPage; 