...
const AllSpeaking = () => {
    ...
    const partDetection = () => {
        switch (testCode) {
            case 'part1':
                setPartEnglishName('Part 1 - Đọc đoạn văn')
                break;
            case 'part2':
                setPartEnglishName('Part 2 - Miêu tả tranh')
                break;
            case 'part3':
                setPartEnglishName('Part 3 - Trả lời câu hỏi')
                break;
            case 'part4':
                setPartEnglishName('Part 4 - Trình bày quan điểm')
                break;
    ...
    return (
        <div>
            ...
            <div className="allSpeakingContainer">
                <Collapse
