...
const DetailPart = (props) => {
    ...
    return (
        <div>
            <div className="detailPartContainer">
                <div className="anchor" style={{ width: '100%' }}>
                    <Table pagination={false} dataSource={dataSource} columns={columns} />
                    <CustomDetailModal open={open} hideModal={hideModal} data={data} questionNumber={questionNumber} part={props.part} userAnswer={props.userAnswer} result={result} />
                </div>
